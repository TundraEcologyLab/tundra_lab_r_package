...
#'
#' A function designed for troubleshooting. After running list_erroneous_files() a
#' file (erroneous_files.txt) will be produced containing a list of all compiled files
...
#' conceivable any other function you might wish to apply to the parent files). This
